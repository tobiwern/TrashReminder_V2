...
//        text += "<label for='taskType" + i + "' id='taskTypel" + i + "'> " + gDataTasks[i] + "</label><div></td>";
        text += "<input type='text' id='taskType_desc" + i + "' value='" + gDataTasks[i] + "' size='100' onfocusout='sendTaskDescriptionToESP();refreshTaskDates();'></div></td>";
...
//        text += "<label for='task" + i + "' id='taskl" + i + "'> " + tasks[i] + "</label><div></td>";
        text += "<input type='text' id='taskdesc" + i + "' value='" + tasks[i] + "' size='100'></div></td>";
