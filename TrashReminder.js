...
//        text += "<label for='taskType" + i + "' id='taskTypel" + i + "'> " + gDataTasks[i] + "</label><div></td>";
        text += "<input type='text id='taskType_desc" + i + "' value='" + gDataTasks[i] + "' width='80' onfocusout='sendTaskDescriptionToESP()'></input><div></td>";
...
//        text += "<label for='task" + i + "' id='taskl" + i + "'> " + tasks[i] + "</label><div></td>";
        text += "<input type='text' id='taskdesc" + i + "' value='" + tasks[i] + "' width='80'></input><div></td>";
